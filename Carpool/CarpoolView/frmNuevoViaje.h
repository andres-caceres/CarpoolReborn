...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox7->Margin = System::Windows::Forms::Padding(1, 1, 1, 1);
			...
			this->comboBox6->Margin = System::Windows::Forms::Padding(1, 1, 1, 1);
			...
			this->comboBox5->Margin = System::Windows::Forms::Padding(1, 1, 1, 1);
			...
			this->comboBox4->Margin = System::Windows::Forms::Padding(1, 1, 1, 1);
			...
			this->comboBox3->Margin = System::Windows::Forms::Padding(1, 1, 1, 1);
			...
			this->comboBox2->Margin = System::Windows::Forms::Padding(1, 1, 1, 1);
